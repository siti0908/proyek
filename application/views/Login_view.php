...
<head>
  ...
  <title>Sistem Informasi Manajemen Matakuliah Proyek</title>
...
<body class="hold-transition login-page" style="overflow-y: hidden;background:url(
  '<?php echo base_url('assets/dist/img/bg2.jpeg');?>')no-repeat;background-size:100%"><div class="login-box">
  
  <div class="login-logo">
     <a href="<?php echo base_url()?>"><b>Sistem Informasi</b><br><B>Manajemen Matakuliah Proyek</B></B></a>
  </div>
  <!-- /.login-logo -->
