...
<html>
    ...
    <div class="box box-warning">
        ...
        <h2 style="margin-top:0px">View Data Penguji </h2>
        <table class="table">
	    <tr><td>Nik Penguji</td><td><?php echo $nik_penguji; ?></td></tr>
	    <tr><td>Nama Penguji</td><td><?php echo $nama_penguji; ?></td></tr>
	    <tr><td>Jenis Kelamin</td><td><?php echo $jenis_kelamin; ?></td></tr>
	    <tr><td></td><td><a href="<?php echo site_url('penguji') ?>" class="btn btn-danger">Cancel</a></td></tr>
	</table>
        </body>
</html>