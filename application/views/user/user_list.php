...
<html>
    ...
    <body>
        ...
        <div class="row" style="margin-bottom: 10px">
          ...
          ?>
            <div class="col-md-4">
            <?php echo anchor(site_url('user/create'),'<i class="fa fa-plus"></i> Create', 'class="btn btn-primary"');?>
            </div>
                <?php
         }
         ?>
                    ...
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('user'); ?>" class="btn btn-danger">Reset</a>
                                    <?php
                                }
                            ?>
...
<tr>
        		...
        		<th>Password</th>
        		<th>Nama Lengkap</th>
        		<th><center>Hak Akses</center></center></th>
			...
			<td><center><?php echo $user->hak_akses ?></center></td>
