...
<html>
    ...
    <div class="box box-warning">
        ...
        <h2 style="margin-top:0px">View Data Dosen </h2>
        <table class="table">
	    <tr><td>Nik Dosen</td><td><?php echo $nik_dosen; ?></td></tr>
	    <tr><td>Nama Dosen</td><td><?php echo $nama_dosen; ?></td></tr>
	    <tr><td></td><td><a href="<?php echo site_url('dosen') ?>" class="btn btn-danger">Cancel</a></td></tr>
	</table>
        </body>
</html>